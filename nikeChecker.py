...
# Define a function for checking Nike product prices
def nikeChecker(userName, URL, userAgent, desiredPrice, userEmail):
    ...
    def title():
        title_element = soup.find(class_="headline-2 css-16cqcdq")
    ...
    def price():
        price_element = soup.find(class_="product-price css-11s12ax is--current-price css-tpaepq")
